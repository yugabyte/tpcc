...
create table customer(
  ...
  primary key((c_w_id, c_d_id) hash, c_id asc)
);
...
create table new_order(
  ...
  primary key((no_w_id, no_d_id) hash, no_o_id asc)
);
...
create table oorder(
  ...
  primary key((o_w_id, o_d_id) hash, o_id asc)
);
...
create table order_line (
  ...
  primary key((ol_w_id, ol_d_id) hash, ol_o_id asc, ol_number asc)
);
